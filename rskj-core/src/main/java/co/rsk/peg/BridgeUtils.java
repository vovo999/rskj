...
public class BridgeUtils {
    ...
    public static boolean isFreeBridgeTx(Transaction rskTx, Constants constants, ActivationConfig.ForBlock activationConfig) {
        ...
        return PrecompiledContracts.BRIDGE_ADDR.equals(receiveAddress) &&
               !activationConfig.isActive(ConsensusRule.ARE_BRIDGE_TXS_PAID) &&
