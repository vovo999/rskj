...
public enum BridgeMethods {
    ADD_FEDERATOR_PUBLIC_KEY(
            ...
            blockchainConfig -> !blockchainConfig.isActive(RSKIP123),
            false
    ),
    ...
    ADD_LOCK_WHITELIST_ADDRESS(
            ...
            blockChainConfig -> !blockChainConfig.isActive(RSKIP87),
            false
    ),
    ...
    GET_BTC_BLOCKCHAIN_INITIAL_BLOCK_HEIGHT(
            ...
            blockchainConfig -> blockchainConfig.isActive(RSKIP89),
            true
    ),
    ...
    public Boolean isEnabled(ActivationConfig.ForBlock activationConfig) {
        return this.isEnabledFunction.apply(activationConfig);
    }
