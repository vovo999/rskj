...
public class PrecompiledContracts {
    ...
    private static final String ALT_BN128_ADD_ADDR = "0000000000000000000000000000000000000006";
    private static final String ALT_BN128_MUL_ADDR = "0000000000000000000000000000000000000007";
    private static final String ALT_BN128_PAIRING_ADDR = "0000000000000000000000000000000000000008";
    ...
    public static final DataWord ALT_BN128_ADD_ADDR_DW = new DataWord(ALT_BN128_ADD_ADDR);
    public static final DataWord ALT_BN128_MUL_ADDR_DW = new DataWord(ALT_BN128_MUL_ADDR);
    public static final DataWord ALT_BN128_PAIRING_ADDR_DW = new DataWord(ALT_BN128_PAIRING_ADDR);
    ...
    private static BN128Addition altBN128Add = new BN128Addition();
    private static BN128Multiplication altBN128Mul = new BN128Multiplication();
    private static BN128Pairing altBN128Pairing = new BN128Pairing();
    ...
    public PrecompiledContract getContractForAddress(BlockchainConfig blockchainConfig, DataWord address) {
        ...
        if (address.equals(ALT_BN128_ADD_ADDR_DW) && blockchainConfig.isRskipPrecompiledContracts()) {
            return altBN128Add;
        }
        if (address.equals(ALT_BN128_MUL_ADDR_DW) && blockchainConfig.isRskipPrecompiledContracts()) {
            return altBN128Mul;
        }
        if (address.equals(ALT_BN128_PAIRING_ADDR_DW) && blockchainConfig.isRskipPrecompiledContracts()) {
