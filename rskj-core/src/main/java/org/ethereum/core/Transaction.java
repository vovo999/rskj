...
public class Transaction {
    ...
    public long transactionCost(Constants constants, ActivationConfig.ForBlock activationConfig) {
        // Federators txs to the bridge are free during system setup
        if (BridgeUtils.isFreeBridgeTx(this, constants, activationConfig)) {
            return 0;
        }
