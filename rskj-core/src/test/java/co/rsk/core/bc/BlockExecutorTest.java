...
public class BlockExecutorTest {
    ...
    public void executeBlockWithOneTransaction() {
        ...
        Assert.assertArrayEquals(
                calculateReceiptsTrieRoot(result.getTransactionReceipts(), block.getNumber()),
    ...
    public void executeBlockWithTwoTransactions() {
        ...
        Assert.assertFalse(Arrays.equals(parent.getStateRoot(), result.getStateRoot()));
    ...
    public void executeAndFillBlockWithOneTransaction() {
        ...
        ), getStateRootHandler(), config.getActivationConfig());
    ...
    private byte[] calculateTxTrieRoot(List<Transaction> transactions, long blockNumber) {
        return BlockHashesHelper.getTxTrieRoot(
                transactions,
                config.getBlockchainConfig().getConfigForBlock(blockNumber).isRskipUnitrie()
        );
    }
    ...
    private static StateRootHandler getStateRootHandler() {
        return new StateRootHandler(config.getActivationConfig(), new TrieConverter(), new HashMapDB(), new HashMap<>());
    }
