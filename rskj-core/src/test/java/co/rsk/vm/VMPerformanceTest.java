...
public class VMPerformanceTest {
    ...
    private final ActivationConfig.ForBlock activationConfig = cr -> true;
    ...
    public long measureProgram(String opcode, byte[] code, int insCount, int divisor, long refTime, int cloneCount, ResultLogger resultLogger) {
        ...
        program = new Program(vmConfig, precompiledContracts, blockFactory, activationConfig, newCode, invoke, null);
    ...
    function()  {
        ...
        */
        ...
        program =new Program(vmConfig, precompiledContracts, blockFactory, activationConfig, code, invoke, null);
