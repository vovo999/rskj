...
public class HDWalletUtilsTest {
    ...
    public void createContract() {
        ...
        contract = new HDWalletUtils(config, new RskAddress("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
        ExecutionEnvironment executionEnvironment = mock(ExecutionEnvironment.class);
        contract = spy(new HDWalletUtils(config, new RskAddress("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")));
