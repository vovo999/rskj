...
public class Web3ImplTest {
    ...
    public void getBalanceWithAccountAndBlockWithTransaction() throws Exception {
        ...
        TransactionPool transactionPool = new TransactionPoolImpl(
                config, world.getRepository(), blockChain.getBlockStore(), null,
                blockFactory, null, null, 10, 100
        );
    ...
    public void eth_sendTransaction()
    {
        ...
        BlockChainImpl blockChain = world.getBlockChain();
        TransactionPool transactionPool = new TransactionPoolImpl(
                config, world.getRepository(), blockChain.getBlockStore(), null, blockFactory,
                null, null, 10, 100
        );
        Web3Impl web3 = createWeb3(world, transactionPool, receiptStore);
